...
namespace OpenRiaServices.VisualStudio.DomainServices.Tools
{
    ...
    /// </summary>
    public class LinqToSqlContext : BusinessLogicContext
    {
        ...
        /// </summary>
        public static string LinqToSqlDomainServiceAssemblyPath
        {
            get
            {
        ...
        /// reset the override.
        /// </param>
        public static void OverrideAssemblyPath(string assemblyPath)
        {
