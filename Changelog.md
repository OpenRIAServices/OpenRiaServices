...
* Fixed stale client association and identity lookups after modifying a tracked entity's primary key, including `EntityRef` relationships backed by the target entity key.
