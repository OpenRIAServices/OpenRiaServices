...
Namespace TestDomainServices
    ...
    Partial Public NotInheritable Class ComplexTypes_DomainContext
        ...
        ''' </summary>
        Public Sub New()
            Me.New(New WebDomainClient(Of IComplexTypes_DomainServiceContract)(New Uri("TestDomainServices-ComplexTypes_DomainService.svc", UriKind.Relative)))
        End Sub
        ...
        Public Sub New(ByVal serviceUri As Uri)
            Me.New(New WebDomainClient(Of IComplexTypes_DomainServiceContract)(serviceUri))
        End Sub
        ...
        Public Overloads Function GetHighestChild(ByVal child As ComplexInheritance_Child, ByVal children() As ComplexInheritance_Child, ByVal callback As Action(Of InvokeOperation(Of ComplexInheritance_Child)), ByVal userState As Object) As InvokeOperation(Of ComplexInheritance_Child)
            ...
            Return CType(Me.InvokeOperation("GetHighestChild", GetType(ComplexInheritance_Child), parameters, true, callback, userState),InvokeOperation(Of ComplexInheritance_Child))
        End Function
        ...
        Public Overloads Function GetHighestChild(ByVal child As ComplexInheritance_Child, ByVal children() As ComplexInheritance_Child) As InvokeOperation(Of ComplexInheritance_Child)
            ...
            parameters.Add("children", children)
            Me.ValidateMethod("GetHighestChild", parameters)
            Return CType(Me.InvokeOperation("GetHighestChild", GetType(ComplexInheritance_Child), parameters, true, Nothing, Nothing),InvokeOperation(Of ComplexInheritance_Child))
        End Function
        ...
        Public Overloads Function GetInheritedMember(ByVal child As ComplexInheritance_Child, ByVal callback As Action(Of InvokeOperation(Of ComplexInheritance_Child)), ByVal userState As Object) As InvokeOperation(Of ComplexInheritance_Child)
            ...
            Return CType(Me.InvokeOperation("GetInheritedMember", GetType(ComplexInheritance_Child), parameters, true, callback, userState),InvokeOperation(Of ComplexInheritance_Child))
        End Function
        ...
        Public Overloads Function GetInheritedMember(ByVal child As ComplexInheritance_Child) As InvokeOperation(Of ComplexInheritance_Child)
            ...
            parameters.Add("child", child)
            Me.ValidateMethod("GetInheritedMember", parameters)
            Return CType(Me.InvokeOperation("GetInheritedMember", GetType(ComplexInheritance_Child), parameters, true, Nothing, Nothing),InvokeOperation(Of ComplexInheritance_Child))
        End Function
        ...
        Public Interface IComplexTypes_DomainServiceContract
            ...
            <FaultContract(GetType(DomainServiceFault), Action:="http://tempuri.org/ComplexTypes_DomainService/GetHighestChildDomainServiceFault", Name:="DomainServiceFault", [Namespace]:="DomainServices"),  _
            ...
            ''' <param name="asyncState">Optional state object.</param>
            ''' <returns>An IAsyncResult that can be used to monitor the request.</returns>
            <FaultContract(GetType(DomainServiceFault), Action:="http://tempuri.org/ComplexTypes_DomainService/GetInheritedMemberDomainServiceFaul"& _ 
            ...
            ''' <param name="asyncState">Optional state object.</param>
            ''' <returns>An IAsyncResult that can be used to monitor the request.</returns>
            <FaultContract(GetType(DomainServiceFault), Action:="http://tempuri.org/ComplexTypes_DomainService/GetStubDomainServiceFault", Name:="DomainServiceFault", [Namespace]:="DomainServices"),  _
            ...
            ''' <param name="asyncState">Optional state object.</param>
            ''' <returns>An IAsyncResult that can be used to monitor the request.</returns>
            <FaultContract(GetType(DomainServiceFault), Action:="http://tempuri.org/ComplexTypes_DomainService/SubmitChangesDomainServiceFault", Name:="DomainServiceFault", [Namespace]:="DomainServices"),  _
    ...
    Partial Public NotInheritable Class ComplexTypes_InvokeOperationsOnly
        ...
        ''' </summary>
        Public Sub New()
            Me.New(New WebDomainClient(Of IComplexTypes_InvokeOperationsOnlyContract)(New Uri("TestDomainServices-ComplexTypes_InvokeOperationsOnly.svc", UriKind.Relative)))
        End Sub
        ...
        Public Sub New(ByVal serviceUri As Uri)
            Me.New(New WebDomainClient(Of IComplexTypes_InvokeOperationsOnlyContract)(serviceUri))
        End Sub
        ...
        Public Overloads Function RoundtripAddress(ByVal address As Address, ByVal callback As Action(Of InvokeOperation(Of Address)), ByVal userState As Object) As InvokeOperation(Of Address)
            ...
            Return CType(Me.InvokeOperation("RoundtripAddress", GetType(Address), parameters, true, callback, userState),InvokeOperation(Of Address))
        End Function
        ...
        Public Overloads Function RoundtripAddress(ByVal address As Address) As InvokeOperation(Of Address)
            ...
            parameters.Add("address", address)
            Me.ValidateMethod("RoundtripAddress", parameters)
            Return CType(Me.InvokeOperation("RoundtripAddress", GetType(Address), parameters, true, Nothing, Nothing),InvokeOperation(Of Address))
        End Function
        ...
        Public Interface IComplexTypes_InvokeOperationsOnlyContract
            ...
            ''' <param name="asyncState">Optional state object.</param>
            ''' <returns>An IAsyncResult that can be used to monitor the request.</returns>
            <FaultContract(GetType(DomainServiceFault), Action:="http://tempuri.org/ComplexTypes_InvokeOperationsOnly/RoundtripAddressDomainServic"& _ 
            ...
            ''' <param name="asyncState">Optional state object.</param>
            ''' <returns>An IAsyncResult that can be used to monitor the request.</returns>
            <FaultContract(GetType(DomainServiceFault), Action:="http://tempuri.org/ComplexTypes_InvokeOperationsOnly/UpdateContactDomainServiceFa"& _ 
    ...
    Partial Public NotInheritable Class ComplexTypes_TestContext
        ...
        ''' </summary>
        Public Sub New()
            Me.New(New WebDomainClient(Of IComplexTypes_TestServiceContract)(New Uri("TestDomainServices-ComplexTypes_TestService.svc", UriKind.Relative)))
        End Sub
        ...
        Public Sub New(ByVal serviceUri As Uri)
            Me.New(New WebDomainClient(Of IComplexTypes_TestServiceContract)(serviceUri))
        End Sub
        ...
        Public Overloads Function ReturnHomeAddress(ByVal contact As ContactInfo, ByVal callback As Action(Of InvokeOperation(Of Address)), ByVal userState As Object) As InvokeOperation(Of Address)
            ...
            Return CType(Me.InvokeOperation("ReturnHomeAddress", GetType(Address), parameters, true, callback, userState),InvokeOperation(Of Address))
        End Function
        ...
        Public Overloads Function ReturnHomeAddress(ByVal contact As ContactInfo) As InvokeOperation(Of Address)
            ...
            parameters.Add("contact", contact)
            Me.ValidateMethod("ReturnHomeAddress", parameters)
            Return CType(Me.InvokeOperation("ReturnHomeAddress", GetType(Address), parameters, true, Nothing, Nothing),InvokeOperation(Of Address))
        End Function
        ...
        Public Interface IComplexTypes_TestServiceContract
            ...
            ''' <param name="asyncState">Optional state object.</param>
            ''' <returns>An IAsyncResult that can be used to monitor the request.</returns>
            <FaultContract(GetType(DomainServiceFault), Action:="http://tempuri.org/ComplexTypes_TestService/GetParentsDomainServiceFault", Name:="DomainServiceFault", [Namespace]:="DomainServices"),  _
            ...
            ''' <param name="asyncState">Optional state object.</param>
            ''' <returns>An IAsyncResult that can be used to monitor the request.</returns>
            <FaultContract(GetType(DomainServiceFault), Action:="http://tempuri.org/ComplexTypes_TestService/ReturnHomeAddressDomainServiceFault", Name:="DomainServiceFault", [Namespace]:="DomainServices"),  _
            ...
            ''' <param name="asyncState">Optional state object.</param>
            ''' <returns>An IAsyncResult that can be used to monitor the request.</returns>
            <FaultContract(GetType(DomainServiceFault), Action:="http://tempuri.org/ComplexTypes_TestService/RoundtripAddressDomainServiceFault", Name:="DomainServiceFault", [Namespace]:="DomainServices"),  _
            ...
            ''' <param name="asyncState">Optional state object.</param>
            ''' <returns>An IAsyncResult that can be used to monitor the request.</returns>
            <FaultContract(GetType(DomainServiceFault), Action:="http://tempuri.org/ComplexTypes_TestService/SubmitChangesDomainServiceFault", Name:="DomainServiceFault", [Namespace]:="DomainServices"),  _
