...
Namespace TestDomainServices
    ...
    Partial Public NotInheritable Class MockCustomer
        ...
        Protected Overrides Sub OnActionStateChanged()
            MyBase.UpdateActionState("MockCustomerCustomMethod", "CanMockCustomerCustomMethod", "IsMockCustomerCustomMethodInvoked")
        End Sub
    End Class
    ...
    Partial Public NotInheritable Class MockCustomerDomainContext
        ...
        ''' </summary>
        Public Sub New()
            Me.New(New WebDomainClient(Of IMockCustomerDomainServiceContract)(New Uri("TestDomainServices-MockCustomerDomainService.svc", UriKind.Relative)))
        End Sub
        ...
        Public Sub New(ByVal serviceUri As Uri)
            Me.New(New WebDomainClient(Of IMockCustomerDomainServiceContract)(serviceUri))
        End Sub
        ...
        Public Interface IMockCustomerDomainServiceContract
            ...
            <FaultContract(GetType(DomainServiceFault), Action:="http://tempuri.org/MockCustomerDomainService/GetCustomersDomainServiceFault", Name:="DomainServiceFault", [Namespace]:="DomainServices"),  _
            ...
            ''' <param name="asyncState">Optional state object.</param>
            ''' <returns>An IAsyncResult that can be used to monitor the request.</returns>
            <FaultContract(GetType(DomainServiceFault), Action:="http://tempuri.org/MockCustomerDomainService/GetReportsDomainServiceFault", Name:="DomainServiceFault", [Namespace]:="DomainServices"),  _
            ...
            ''' <param name="asyncState">Optional state object.</param>
            ''' <returns>An IAsyncResult that can be used to monitor the request.</returns>
            <FaultContract(GetType(DomainServiceFault), Action:="http://tempuri.org/MockCustomerDomainService/SubmitChangesDomainServiceFault", Name:="DomainServiceFault", [Namespace]:="DomainServices"),  _
    ...
    Partial Public NotInheritable Class MockReport
        ...
        Protected Overrides Sub OnActionStateChanged()
            MyBase.UpdateActionState("MockReportCustomMethod", "CanMockReportCustomMethod", "IsMockReportCustomMethodInvoked")
        End Sub
    End Class
