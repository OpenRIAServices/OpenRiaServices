...
namespace TestDomainServices.TypeNameConflictResolution
{
    ...
    /// </summary>
    public sealed partial class BaseTypeConflicts : System.ServiceModel.DomainServices.Client.DomainContext
    {
        ...
        public BaseTypeConflicts() : 
                this(new WebDomainClient<IBaseTypeConflictsContract>(new Uri("TestDomainServices-TypeNameConflictResolution-BaseTypeConflicts.svc", UriKind.Relative)))
        {
        }
        ...
        public BaseTypeConflicts(Uri serviceUri) : 
                this(new WebDomainClient<IBaseTypeConflictsContract>(serviceUri))
        {
        }
        ...
        public interface IBaseTypeConflictsContract
        {
            ...
            [FaultContract(typeof(DomainServiceFault), Action="http://tempuri.org/BaseTypeConflicts/GetDataContextsDomainServiceFault", Name="DomainServiceFault", Namespace="DomainServices")]
            ...
            /// <param name="asyncState">Optional state object.</param>
            /// <returns>An IAsyncResult that can be used to monitor the request.</returns>
            [FaultContract(typeof(DomainServiceFault), Action="http://tempuri.org/BaseTypeConflicts/GetEntitiesDomainServiceFault", Name="DomainServiceFault", Namespace="DomainServices")]
    ...
    [DataContract(Namespace="http://schemas.datacontract.org/2004/07/TestDomainServices.TypeNameConflictResolu" +
        "tion")]
    public sealed partial class DomainContext : System.ServiceModel.DomainServices.Client.Entity
    {
    ...
    [DataContract(Namespace="http://schemas.datacontract.org/2004/07/TestDomainServices.TypeNameConflictResolu" +
        "tion")]
    public sealed partial class Entity : System.ServiceModel.DomainServices.Client.Entity
    {
...
namespace TestDomainServices.TypeNameConflictResolution.ExternalConflicts
{
    ...
    public sealed partial class DomainServiceScenario1 : DomainContext
    {
        ...
        public DomainServiceScenario1() : 
                this(new WebDomainClient<IDomainServiceScenario1Contract>(new Uri("TestDomainServices-TypeNameConflictResolution-ExternalConflicts-DomainServiceScen" +
        ...
        public DomainServiceScenario1(Uri serviceUri) : 
                this(new WebDomainClient<IDomainServiceScenario1Contract>(serviceUri))
        {
        }
        ...
        public interface IDomainServiceScenario1Contract
        {
            ...
            /// <param name="asyncState">Optional state object.</param>
            /// <returns>An IAsyncResult that can be used to monitor the request.</returns>
            [FaultContract(typeof(DomainServiceFault), Action="http://tempuri.org/DomainServiceScenario1/GetTEntity1DomainServiceFault", Name="DomainServiceFault", Namespace="DomainServices")]
            ...
            /// <param name="asyncState">Optional state object.</param>
            /// <returns>An IAsyncResult that can be used to monitor the request.</returns>
            [FaultContract(typeof(DomainServiceFault), Action="http://tempuri.org/DomainServiceScenario1/GetTEntity2DomainServiceFault", Name="DomainServiceFault", Namespace="DomainServices")]
    ...
    public sealed partial class DomainServiceScenario2 : DomainContext
    {
        ...
        public DomainServiceScenario2() : 
                this(new WebDomainClient<IDomainServiceScenario2Contract>(new Uri("TestDomainServices-TypeNameConflictResolution-ExternalConflicts-DomainServiceScen" +
        ...
        public DomainServiceScenario2(Uri serviceUri) : 
                this(new WebDomainClient<IDomainServiceScenario2Contract>(serviceUri))
        {
        }
        ...
        public interface IDomainServiceScenario2Contract
        {
            ...
            /// <param name="asyncState">Optional state object.</param>
            /// <returns>An IAsyncResult that can be used to monitor the request.</returns>
            [FaultContract(typeof(DomainServiceFault), Action="http://tempuri.org/DomainServiceScenario2/GetTEntity1DomainServiceFault", Name="DomainServiceFault", Namespace="DomainServices")]
            ...
            /// <param name="asyncState">Optional state object.</param>
            /// <returns>An IAsyncResult that can be used to monitor the request.</returns>
            [FaultContract(typeof(DomainServiceFault), Action="http://tempuri.org/DomainServiceScenario2/GetTEntity2DomainServiceFault", Name="DomainServiceFault", Namespace="DomainServices")]
