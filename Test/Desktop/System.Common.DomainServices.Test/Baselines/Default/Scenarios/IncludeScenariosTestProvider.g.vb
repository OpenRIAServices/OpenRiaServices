...
Namespace TestDomainServices
    ...
    Partial Public NotInheritable Class IncludeScenariosTestProvider
        ...
        ''' </summary>
        Public Sub New()
            Me.New(New WebDomainClient(Of IIncludeScenariosTestProviderContract)(New Uri("TestDomainServices-IncludeScenariosTestProvider.svc", UriKind.Relative)))
        End Sub
        ...
        Public Sub New(ByVal serviceUri As Uri)
            Me.New(New WebDomainClient(Of IIncludeScenariosTestProviderContract)(serviceUri))
        End Sub
        ...
        Public Interface IIncludeScenariosTestProviderContract
            ...
            <FaultContract(GetType(DomainServiceFault), Action:="http://tempuri.org/IncludeScenariosTestProvider/GetAsDomainServiceFault", Name:="DomainServiceFault", [Namespace]:="DomainServices"),  _
