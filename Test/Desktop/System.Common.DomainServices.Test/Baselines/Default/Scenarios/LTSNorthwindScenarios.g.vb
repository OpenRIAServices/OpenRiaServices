...
Namespace DataTests.Scenarios.LTS.Northwind
    ...
    Partial Public NotInheritable Class LTS_NorthwindScenarios
        ...
        ''' </summary>
        Public Sub New()
            Me.New(New WebDomainClient(Of ILTS_NorthwindScenariosContract)(New Uri("DataTests-Scenarios-LTS-Northwind-LTS_NorthwindScenarios.svc", UriKind.Relative)))
        End Sub
        ...
        Public Sub New(ByVal serviceUri As Uri)
            Me.New(New WebDomainClient(Of ILTS_NorthwindScenariosContract)(serviceUri))
        End Sub
        ...
        Public Interface ILTS_NorthwindScenariosContract
            ...
            <FaultContract(GetType(DomainServiceFault), Action:="http://tempuri.org/LTS_NorthwindScenarios/GetCustomer_Bug479436sDomainServiceFaul"& _ 
            ...
            ''' <param name="asyncState">Optional state object.</param>
            ''' <returns>An IAsyncResult that can be used to monitor the request.</returns>
            <FaultContract(GetType(DomainServiceFault), Action:="http://tempuri.org/LTS_NorthwindScenarios/GetOrder_Bug479436sDomainServiceFault", Name:="DomainServiceFault", [Namespace]:="DomainServices"),  _
            ...
            ''' <param name="asyncState">Optional state object.</param>
            ''' <returns>An IAsyncResult that can be used to monitor the request.</returns>
            <FaultContract(GetType(DomainServiceFault), Action:="http://tempuri.org/LTS_NorthwindScenarios/GetRequiredAttributeTestEntitiesDomainS"& _ 
