...
namespace SharedEntities
{
    ...
    public sealed partial class ExposeChildEntityDomainContext : DomainContext
    {
        ...
        public ExposeChildEntityDomainContext() : 
                this(new WebDomainClient<IExposeChildEntityDomainServiceContract>(new Uri("SharedEntities-ExposeChildEntityDomainService.svc", UriKind.Relative)))
        {
        }
        ...
        public ExposeChildEntityDomainContext(Uri serviceUri) : 
                this(new WebDomainClient<IExposeChildEntityDomainServiceContract>(serviceUri))
        {
        }
        ...
        public interface IExposeChildEntityDomainServiceContract
        {
            ...
            [FaultContract(typeof(DomainServiceFault), Action="http://tempuri.org/ExposeChildEntityDomainService/GetADomainServiceFault", Name="DomainServiceFault", Namespace="DomainServices")]
            ...
            /// <param name="asyncState">Optional state object.</param>
            /// <returns>An IAsyncResult that can be used to monitor the request.</returns>
            [FaultContract(typeof(DomainServiceFault), Action="http://tempuri.org/ExposeChildEntityDomainService/GetBDomainServiceFault", Name="DomainServiceFault", Namespace="DomainServices")]
            ...
            /// <param name="asyncState">Optional state object.</param>
            /// <returns>An IAsyncResult that can be used to monitor the request.</returns>
            [FaultContract(typeof(DomainServiceFault), Action="http://tempuri.org/ExposeChildEntityDomainService/GetXDomainServiceFault", Name="DomainServiceFault", Namespace="DomainServices")]
            ...
            /// <param name="asyncState">Optional state object.</param>
            /// <returns>An IAsyncResult that can be used to monitor the request.</returns>
            [FaultContract(typeof(DomainServiceFault), Action="http://tempuri.org/ExposeChildEntityDomainService/GetYDomainServiceFault", Name="DomainServiceFault", Namespace="DomainServices")]
            ...
            /// <param name="asyncState">Optional state object.</param>
            /// <returns>An IAsyncResult that can be used to monitor the request.</returns>
            [FaultContract(typeof(DomainServiceFault), Action="http://tempuri.org/ExposeChildEntityDomainService/SubmitChangesDomainServiceFault" +
    ...
    public sealed partial class ExposeParentEntityDomainContext : DomainContext
    {
        ...
        public ExposeParentEntityDomainContext() : 
                this(new WebDomainClient<IExposeParentEntityDomainServiceContract>(new Uri("SharedEntities-ExposeParentEntityDomainService.svc", UriKind.Relative)))
        {
        }
        ...
        public ExposeParentEntityDomainContext(Uri serviceUri) : 
                this(new WebDomainClient<IExposeParentEntityDomainServiceContract>(serviceUri))
        {
        }
        ...
        public interface IExposeParentEntityDomainServiceContract
        {
            ...
            /// <param name="asyncState">Optional state object.</param>
            /// <returns>An IAsyncResult that can be used to monitor the request.</returns>
            [FaultContract(typeof(DomainServiceFault), Action="http://tempuri.org/ExposeParentEntityDomainService/GetADomainServiceFault", Name="DomainServiceFault", Namespace="DomainServices")]
            ...
            /// <param name="asyncState">Optional state object.</param>
            /// <returns>An IAsyncResult that can be used to monitor the request.</returns>
            [FaultContract(typeof(DomainServiceFault), Action="http://tempuri.org/ExposeParentEntityDomainService/GetCDomainServiceFault", Name="DomainServiceFault", Namespace="DomainServices")]
            ...
            /// <param name="asyncState">Optional state object.</param>
            /// <returns>An IAsyncResult that can be used to monitor the request.</returns>
            [FaultContract(typeof(DomainServiceFault), Action="http://tempuri.org/ExposeParentEntityDomainService/GetXDomainServiceFault", Name="DomainServiceFault", Namespace="DomainServices")]
            ...
            /// <param name="asyncState">Optional state object.</param>
            /// <returns>An IAsyncResult that can be used to monitor the request.</returns>
            [FaultContract(typeof(DomainServiceFault), Action="http://tempuri.org/ExposeParentEntityDomainService/SubmitChangesDomainServiceFaul" +
