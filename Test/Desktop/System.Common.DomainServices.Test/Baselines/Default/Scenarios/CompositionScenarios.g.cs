...
namespace TestDomainServices
{
    ...
    public sealed partial class CompositionScenarios_Explicit : DomainContext
    {
        ...
        public CompositionScenarios_Explicit() : 
                this(new WebDomainClient<ICompositionScenarios_ExplicitContract>(new Uri("TestDomainServices-CompositionScenarios_Explicit.svc", UriKind.Relative)))
        {
        }
        ...
        public CompositionScenarios_Explicit(Uri serviceUri) : 
                this(new WebDomainClient<ICompositionScenarios_ExplicitContract>(serviceUri))
        {
        }
        ...
        public interface ICompositionScenarios_ExplicitContract
        {
            ...
            [FaultContract(typeof(DomainServiceFault), Action="http://tempuri.org/CompositionScenarios_Explicit/GetParentsDomainServiceFault", Name="DomainServiceFault", Namespace="DomainServices")]
            ...
            /// <param name="asyncState">Optional state object.</param>
            /// <returns>An IAsyncResult that can be used to monitor the request.</returns>
            [FaultContract(typeof(DomainServiceFault), Action="http://tempuri.org/CompositionScenarios_Explicit/SubmitChangesDomainServiceFault", Name="DomainServiceFault", Namespace="DomainServices")]
    ...
    public sealed partial class CompositionScenarios_Various : DomainContext
    {
        ...
        public CompositionScenarios_Various() : 
                this(new WebDomainClient<ICompositionScenarios_VariousContract>(new Uri("TestDomainServices-CompositionScenarios_Various.svc", UriKind.Relative)))
        {
        }
        ...
        public CompositionScenarios_Various(Uri serviceUri) : 
                this(new WebDomainClient<ICompositionScenarios_VariousContract>(serviceUri))
        {
        }
        ...
        public interface ICompositionScenarios_VariousContract
        {
            ...
            /// <param name="asyncState">Optional state object.</param>
            /// <returns>An IAsyncResult that can be used to monitor the request.</returns>
            [FaultContract(typeof(DomainServiceFault), Action="http://tempuri.org/CompositionScenarios_Various/GetChildrenDomainServiceFault", Name="DomainServiceFault", Namespace="DomainServices")]
            ...
            /// <param name="asyncState">Optional state object.</param>
            /// <returns>An IAsyncResult that can be used to monitor the request.</returns>
            [FaultContract(typeof(DomainServiceFault), Action="http://tempuri.org/CompositionScenarios_Various/GetParentsDomainServiceFault", Name="DomainServiceFault", Namespace="DomainServices")]
            ...
            /// <param name="asyncState">Optional state object.</param>
            /// <returns>An IAsyncResult that can be used to monitor the request.</returns>
            [FaultContract(typeof(DomainServiceFault), Action="http://tempuri.org/CompositionScenarios_Various/GetSelfReferencingComposition_One" +
                "ToManysDomainServiceFault", Name="DomainServiceFault", Namespace="DomainServices")]
            ...
            /// <param name="asyncState">Optional state object.</param>
            /// <returns>An IAsyncResult that can be used to monitor the request.</returns>
            [FaultContract(typeof(DomainServiceFault), Action="http://tempuri.org/CompositionScenarios_Various/GetSelfReferencingCompositionsDom" +
            ...
            /// <param name="asyncState">Optional state object.</param>
            /// <returns>An IAsyncResult that can be used to monitor the request.</returns>
            [FaultContract(typeof(DomainServiceFault), Action="http://tempuri.org/CompositionScenarios_Various/SubmitChangesDomainServiceFault", Name="DomainServiceFault", Namespace="DomainServices")]
