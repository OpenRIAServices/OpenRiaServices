...
namespace TestDomainServices
{
    ...
    public sealed partial class AssociationInheritanceScenarios : DomainContext
    {
        ...
        public AssociationInheritanceScenarios() : 
                this(new WebDomainClient<IAssociationInheritanceScenariosContract>(new Uri("TestDomainServices-AssociationInheritanceScenarios.svc", UriKind.Relative)))
        {
        }
        ...
        public AssociationInheritanceScenarios(Uri serviceUri) : 
                this(new WebDomainClient<IAssociationInheritanceScenariosContract>(serviceUri))
        {
        }
        ...
        public interface IAssociationInheritanceScenariosContract
        {
            ...
            [FaultContract(typeof(DomainServiceFault), Action="http://tempuri.org/AssociationInheritanceScenarios/GetDetailsDomainServiceFault", Name="DomainServiceFault", Namespace="DomainServices")]
            ...
            /// <param name="asyncState">Optional state object.</param>
            /// <returns>An IAsyncResult that can be used to monitor the request.</returns>
            [FaultContract(typeof(DomainServiceFault), Action="http://tempuri.org/AssociationInheritanceScenarios/GetMastersDomainServiceFault", Name="DomainServiceFault", Namespace="DomainServices")]
            ...
            /// <param name="asyncState">Optional state object.</param>
            /// <returns>An IAsyncResult that can be used to monitor the request.</returns>
            [FaultContract(typeof(DomainServiceFault), Action="http://tempuri.org/AssociationInheritanceScenarios/SubmitChangesDomainServiceFaul" +
    ...
    public sealed partial class CompositionInheritanceScenarios : DomainContext
    {
        ...
        public CompositionInheritanceScenarios() : 
                this(new WebDomainClient<ICompositionInheritanceScenariosContract>(new Uri("TestDomainServices-CompositionInheritanceScenarios.svc", UriKind.Relative)))
        {
        }
        ...
        public CompositionInheritanceScenarios(Uri serviceUri) : 
                this(new WebDomainClient<ICompositionInheritanceScenariosContract>(serviceUri))
        {
        }
        ...
        public interface ICompositionInheritanceScenariosContract
        {
            ...
            /// <param name="asyncState">Optional state object.</param>
            /// <returns>An IAsyncResult that can be used to monitor the request.</returns>
            [FaultContract(typeof(DomainServiceFault), Action="http://tempuri.org/CompositionInheritanceScenarios/GetParentsDomainServiceFault", Name="DomainServiceFault", Namespace="DomainServices")]
            ...
            /// <param name="asyncState">Optional state object.</param>
            /// <returns>An IAsyncResult that can be used to monitor the request.</returns>
            [FaultContract(typeof(DomainServiceFault), Action="http://tempuri.org/CompositionInheritanceScenarios/SubmitChangesDomainServiceFaul" +
                "t", Name="DomainServiceFault", Namespace="DomainServices")]
