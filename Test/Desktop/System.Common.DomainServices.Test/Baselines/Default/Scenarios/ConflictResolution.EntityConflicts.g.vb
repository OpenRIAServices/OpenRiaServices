...
Namespace TestDomainServices.TypeNameConflictResolution
    ...
    Partial Public NotInheritable Class BaseTypeConflicts
        ...
        ''' </summary>
        Public Sub New()
            Me.New(New WebDomainClient(Of IBaseTypeConflictsContract)(New Uri("TestDomainServices-TypeNameConflictResolution-BaseTypeConflicts.svc", UriKind.Relative)))
        End Sub
        ...
        Public Sub New(ByVal serviceUri As Uri)
            Me.New(New WebDomainClient(Of IBaseTypeConflictsContract)(serviceUri))
        End Sub
        ...
        Public Interface IBaseTypeConflictsContract
            ...
            <FaultContract(GetType(DomainServiceFault), Action:="http://tempuri.org/BaseTypeConflicts/GetDataContextsDomainServiceFault", Name:="DomainServiceFault", [Namespace]:="DomainServices"),  _
            ...
            ''' <param name="asyncState">Optional state object.</param>
            ''' <returns>An IAsyncResult that can be used to monitor the request.</returns>
            <FaultContract(GetType(DomainServiceFault), Action:="http://tempuri.org/BaseTypeConflicts/GetEntitiesDomainServiceFault", Name:="DomainServiceFault", [Namespace]:="DomainServices"),  _
...
Namespace TestDomainServices.TypeNameConflictResolution.ExternalConflicts
    ...
    Partial Public NotInheritable Class DomainServiceScenario1
        ...
        ''' </summary>
        Public Sub New()
            Me.New(New WebDomainClient(Of IDomainServiceScenario1Contract)(New Uri("TestDomainServices-TypeNameConflictResolution-ExternalConflicts-DomainServiceScen"& _ 
        ...
        Public Sub New(ByVal serviceUri As Uri)
            Me.New(New WebDomainClient(Of IDomainServiceScenario1Contract)(serviceUri))
        End Sub
        ...
        Public Interface IDomainServiceScenario1Contract
            ...
            ''' <param name="asyncState">Optional state object.</param>
            ''' <returns>An IAsyncResult that can be used to monitor the request.</returns>
            <FaultContract(GetType(DomainServiceFault), Action:="http://tempuri.org/DomainServiceScenario1/GetTEntity1DomainServiceFault", Name:="DomainServiceFault", [Namespace]:="DomainServices"),  _
            ...
            ''' <param name="asyncState">Optional state object.</param>
            ''' <returns>An IAsyncResult that can be used to monitor the request.</returns>
            <FaultContract(GetType(DomainServiceFault), Action:="http://tempuri.org/DomainServiceScenario1/GetTEntity2DomainServiceFault", Name:="DomainServiceFault", [Namespace]:="DomainServices"),  _
    ...
    Partial Public NotInheritable Class DomainServiceScenario2
        ...
        ''' </summary>
        Public Sub New()
            Me.New(New WebDomainClient(Of IDomainServiceScenario2Contract)(New Uri("TestDomainServices-TypeNameConflictResolution-ExternalConflicts-DomainServiceScen"& _ 
        ...
        Public Sub New(ByVal serviceUri As Uri)
            Me.New(New WebDomainClient(Of IDomainServiceScenario2Contract)(serviceUri))
        End Sub
        ...
        Public Interface IDomainServiceScenario2Contract
            ...
            ''' <param name="asyncState">Optional state object.</param>
            ''' <returns>An IAsyncResult that can be used to monitor the request.</returns>
            <FaultContract(GetType(DomainServiceFault), Action:="http://tempuri.org/DomainServiceScenario2/GetTEntity1DomainServiceFault", Name:="DomainServiceFault", [Namespace]:="DomainServices"),  _
            ...
            ''' <param name="asyncState">Optional state object.</param>
            ''' <returns>An IAsyncResult that can be used to monitor the request.</returns>
            <FaultContract(GetType(DomainServiceFault), Action:="http://tempuri.org/DomainServiceScenario2/GetTEntity2DomainServiceFault", Name:="DomainServiceFault", [Namespace]:="DomainServices"),  _
