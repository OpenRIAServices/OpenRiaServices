...
namespace TestDomainServices
{
    ...
    public sealed partial class AttributeThrowingDomainContext : DomainContext
    {
        ...
        public AttributeThrowingDomainContext() : 
                this(new WebDomainClient<IAttributeThrowingDomainServiceContract>(new Uri("TestDomainServices-AttributeThrowingDomainService.svc", UriKind.Relative)))
        {
        }
        ...
        public AttributeThrowingDomainContext(Uri serviceUri) : 
                this(new WebDomainClient<IAttributeThrowingDomainServiceContract>(serviceUri))
        {
        }
        ...
        public InvokeOperation<bool> InvokeThrowing(int throwingInvokeParam, Action<InvokeOperation<bool>> callback, object userState)
        {
            ...
            return ((InvokeOperation<bool>)(this.InvokeOperation("InvokeThrowing", typeof(bool), parameters, true, callback, userState)));
        }
        ...
        public InvokeOperation<bool> InvokeThrowing(int throwingInvokeParam)
        {
            ...
            parameters.Add("throwingInvokeParam", throwingInvokeParam);
            this.ValidateMethod("InvokeThrowing", parameters);
            return ((InvokeOperation<bool>)(this.InvokeOperation("InvokeThrowing", typeof(bool), parameters, true, null, null)));
        }
        ...
        public interface IAttributeThrowingDomainServiceContract
        {
            ...
            [FaultContract(typeof(DomainServiceFault), Action="http://tempuri.org/AttributeThrowingDomainService/GetThrowingDomainServiceFault", Name="DomainServiceFault", Namespace="DomainServices")]
            ...
            /// <param name="asyncState">Optional state object.</param>
            /// <returns>An IAsyncResult that can be used to monitor the request.</returns>
            [FaultContract(typeof(DomainServiceFault), Action="http://tempuri.org/AttributeThrowingDomainService/InvokeThrowingDomainServiceFaul" +
            ...
            /// <param name="asyncState">Optional state object.</param>
            /// <returns>An IAsyncResult that can be used to monitor the request.</returns>
            [FaultContract(typeof(DomainServiceFault), Action="http://tempuri.org/AttributeThrowingDomainService/SubmitChangesDomainServiceFault" +
    ...
    public sealed partial class AttributeThrowingEntity : Entity
    {
        ...
        {
            base.UpdateActionState("UpdateThrowing", "CanUpdateThrowing", "IsUpdateThrowingInvoked");
        }
    }
}
