...
Namespace TestDomainServices
    ...
    Partial Public NotInheritable Class EntityWithXElement
        ...
        Protected Overrides Sub OnActionStateChanged()
            MyBase.UpdateActionState("EntityWithXElement_Custom_AttributeAggregation", "CanEntityWithXElement_Custom_AttributeAggregation", "IsEntityWithXElement_Custom_AttributeAggregationInvoked")
            MyBase.UpdateActionState("EntityWithXElement_Custom_AttributeOverrides", "CanEntityWithXElement_Custom_AttributeOverrides", "IsEntityWithXElement_Custom_AttributeOverridesInvoked")
        End Sub
    End Class
    ...
    Partial Public NotInheritable Class InterfaceInheritanceDomainContext
        ...
        ''' </summary>
        Public Sub New()
            Me.New(New WebDomainClient(Of IInterfaceInheritanceDomainServiceContract)(New Uri("TestDomainServices-InterfaceInheritanceDomainService.svc", UriKind.Relative)))
        End Sub
        ...
        Public Sub New(ByVal serviceUri As Uri)
            Me.New(New WebDomainClient(Of IInterfaceInheritanceDomainServiceContract)(serviceUri))
        End Sub
        ...
        Public Interface IInterfaceInheritanceDomainServiceContract
            ...
            <FaultContract(GetType(DomainServiceFault), Action:="http://tempuri.org/InterfaceInheritanceDomainService/EntityWithXElement_GetDomain"& _ 
            ...
            ''' <param name="asyncState">Optional state object.</param>
            ''' <returns>An IAsyncResult that can be used to monitor the request.</returns>
            <FaultContract(GetType(DomainServiceFault), Action:="http://tempuri.org/InterfaceInheritanceDomainService/SubmitChangesDomainServiceFa"& _ 
