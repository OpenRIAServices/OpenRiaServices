...
namespace TestDomainServices.DbCtx
{
    ...
    public sealed partial class Catalog : DomainContext
    {
        ...
        /// </summary>
        public Catalog() : 
                this(new WebDomainClient<ICatalogContract>(new Uri("TestDomainServices-DbCtx-Catalog.svc", UriKind.Relative)))
        {
        }
        ...
        public Catalog(Uri serviceUri) : 
                this(new WebDomainClient<ICatalogContract>(serviceUri))
        {
        }
        ...
        public interface ICatalogContract
        {
            ...
            [FaultContract(typeof(DomainServiceFault), Action="http://tempuri.org/Catalog/GetEmployeeInfosDomainServiceFault", Name="DomainServiceFault", Namespace="DomainServices")]
            ...
            /// <param name="asyncState">Optional state object.</param>
            /// <returns>An IAsyncResult that can be used to monitor the request.</returns>
            [FaultContract(typeof(DomainServiceFault), Action="http://tempuri.org/Catalog/GetEmployeesDomainServiceFault", Name="DomainServiceFault", Namespace="DomainServices")]
            ...
            /// <param name="asyncState">Optional state object.</param>
            /// <returns>An IAsyncResult that can be used to monitor the request.</returns>
            [FaultContract(typeof(DomainServiceFault), Action="http://tempuri.org/Catalog/GetProductsDomainServiceFault", Name="DomainServiceFault", Namespace="DomainServices")]
            ...
            /// <param name="asyncState">Optional state object.</param>
            /// <returns>An IAsyncResult that can be used to monitor the request.</returns>
            [FaultContract(typeof(DomainServiceFault), Action="http://tempuri.org/Catalog/GetProductsByCategoryDomainServiceFault", Name="DomainServiceFault", Namespace="DomainServices")]
            ...
            /// <param name="asyncState">Optional state object.</param>
            /// <returns>An IAsyncResult that can be used to monitor the request.</returns>
            [FaultContract(typeof(DomainServiceFault), Action="http://tempuri.org/Catalog/GetProductsWithCachingDomainServiceFault", Name="DomainServiceFault", Namespace="DomainServices")]
            ...
            /// <param name="asyncState">Optional state object.</param>
            /// <returns>An IAsyncResult that can be used to monitor the request.</returns>
            [FaultContract(typeof(DomainServiceFault), Action="http://tempuri.org/Catalog/GetProductsWithCustomTotalCountDomainServiceFault", Name="DomainServiceFault", Namespace="DomainServices")]
            ...
            /// <param name="asyncState">Optional state object.</param>
            /// <returns>An IAsyncResult that can be used to monitor the request.</returns>
            [FaultContract(typeof(DomainServiceFault), Action="http://tempuri.org/Catalog/GetPurchaseOrdersDomainServiceFault", Name="DomainServiceFault", Namespace="DomainServices")]
            ...
            /// <param name="asyncState">Optional state object.</param>
            /// <returns>An IAsyncResult that can be used to monitor the request.</returns>
            [FaultContract(typeof(DomainServiceFault), Action="http://tempuri.org/Catalog/SubmitChangesDomainServiceFault", Name="DomainServiceFault", Namespace="DomainServices")]
