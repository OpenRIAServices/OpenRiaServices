...
Namespace TestDomainServices.DbCtx
    ...
    Partial Public NotInheritable Class Catalog
        ...
        ''' </summary>
        Public Sub New()
            Me.New(New WebDomainClient(Of ICatalogContract)(New Uri("TestDomainServices-DbCtx-Catalog.svc", UriKind.Relative)))
        End Sub
        ...
        Public Sub New(ByVal serviceUri As Uri)
            Me.New(New WebDomainClient(Of ICatalogContract)(serviceUri))
        End Sub
        ...
        Public Interface ICatalogContract
            ...
            <FaultContract(GetType(DomainServiceFault), Action:="http://tempuri.org/Catalog/GetEmployeeInfosDomainServiceFault", Name:="DomainServiceFault", [Namespace]:="DomainServices"),  _
            ...
            ''' <param name="asyncState">Optional state object.</param>
            ''' <returns>An IAsyncResult that can be used to monitor the request.</returns>
            <FaultContract(GetType(DomainServiceFault), Action:="http://tempuri.org/Catalog/GetEmployeesDomainServiceFault", Name:="DomainServiceFault", [Namespace]:="DomainServices"),  _
            ...
            ''' <param name="asyncState">Optional state object.</param>
            ''' <returns>An IAsyncResult that can be used to monitor the request.</returns>
            <FaultContract(GetType(DomainServiceFault), Action:="http://tempuri.org/Catalog/GetProductsDomainServiceFault", Name:="DomainServiceFault", [Namespace]:="DomainServices"),  _
            ...
            ''' <param name="asyncState">Optional state object.</param>
            ''' <returns>An IAsyncResult that can be used to monitor the request.</returns>
            <FaultContract(GetType(DomainServiceFault), Action:="http://tempuri.org/Catalog/GetProductsByCategoryDomainServiceFault", Name:="DomainServiceFault", [Namespace]:="DomainServices"),  _
            ...
            ''' <param name="asyncState">Optional state object.</param>
            ''' <returns>An IAsyncResult that can be used to monitor the request.</returns>
            <FaultContract(GetType(DomainServiceFault), Action:="http://tempuri.org/Catalog/GetProductsWithCachingDomainServiceFault", Name:="DomainServiceFault", [Namespace]:="DomainServices"),  _
            ...
            ''' <param name="asyncState">Optional state object.</param>
            ''' <returns>An IAsyncResult that can be used to monitor the request.</returns>
            <FaultContract(GetType(DomainServiceFault), Action:="http://tempuri.org/Catalog/GetProductsWithCustomTotalCountDomainServiceFault", Name:="DomainServiceFault", [Namespace]:="DomainServices"),  _
            ...
            ''' <param name="asyncState">Optional state object.</param>
            ''' <returns>An IAsyncResult that can be used to monitor the request.</returns>
            <FaultContract(GetType(DomainServiceFault), Action:="http://tempuri.org/Catalog/GetPurchaseOrdersDomainServiceFault", Name:="DomainServiceFault", [Namespace]:="DomainServices"),  _
            ...
            ''' <param name="asyncState">Optional state object.</param>
            ''' <returns>An IAsyncResult that can be used to monitor the request.</returns>
            <FaultContract(GetType(DomainServiceFault), Action:="http://tempuri.org/Catalog/SubmitChangesDomainServiceFault", Name:="DomainServiceFault", [Namespace]:="DomainServices"),  _
