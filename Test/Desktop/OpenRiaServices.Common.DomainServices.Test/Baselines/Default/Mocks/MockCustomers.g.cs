...
namespace TestDomainServices
{
    ...
    public sealed partial class MockCustomerDomainContext : DomainContext
    {
        ...
        public MockCustomerDomainContext() : 
                this(new WebDomainClient<IMockCustomerDomainServiceContract>(new Uri("TestDomainServices-MockCustomerDomainService.svc", UriKind.Relative)))
        {
        }
        ...
        public MockCustomerDomainContext(Uri serviceUri) : 
                this(new WebDomainClient<IMockCustomerDomainServiceContract>(serviceUri))
        {
        }
        ...
        public interface IMockCustomerDomainServiceContract
        {
            ...
            [FaultContract(typeof(DomainServiceFault), Action="http://tempuri.org/MockCustomerDomainService/GetCustomersDomainServiceFault", Name="DomainServiceFault", Namespace="DomainServices")]
            ...
            /// <param name="asyncState">Optional state object.</param>
            /// <returns>An IAsyncResult that can be used to monitor the request.</returns>
            [FaultContract(typeof(DomainServiceFault), Action="http://tempuri.org/MockCustomerDomainService/GetReportsDomainServiceFault", Name="DomainServiceFault", Namespace="DomainServices")]
            ...
            /// <param name="asyncState">Optional state object.</param>
            /// <returns>An IAsyncResult that can be used to monitor the request.</returns>
            [FaultContract(typeof(DomainServiceFault), Action="http://tempuri.org/MockCustomerDomainService/SubmitChangesDomainServiceFault", Name="DomainServiceFault", Namespace="DomainServices")]
