...
Namespace GlobalNamespaceTest
    ...
    Partial Public NotInheritable Class GlobalNamespaceTest_DomainContext
        ...
        ''' </summary>
        Public Sub New()
            Me.New(New WebDomainClient(Of IGlobalNamespaceTest_DomainServiceContract)(New Uri("GlobalNamespaceTest-GlobalNamespaceTest_DomainService.svc", UriKind.Relative)))
        End Sub
        ...
        Public Sub New(ByVal serviceUri As Uri)
            Me.New(New WebDomainClient(Of IGlobalNamespaceTest_DomainServiceContract)(serviceUri))
        End Sub
        ...
        Public Overloads Function InvokeReturn(<GlobalNamespaceTest_Validation()> ByVal enumParameter As GlobalNamespaceTest_Enum, ByVal callback As Action(Of InvokeOperation(Of GlobalNamespaceTest_Enum)), ByVal userState As Object) As InvokeOperation(Of GlobalNamespaceTest_Enum)
            ...
            Return CType(Me.InvokeOperation("InvokeReturn", GetType(GlobalNamespaceTest_Enum), parameters, true, callback, userState),InvokeOperation(Of GlobalNamespaceTest_Enum))
        End Function
        ...
        Public Overloads Function InvokeReturn(<GlobalNamespaceTest_Validation()> ByVal enumParameter As GlobalNamespaceTest_Enum) As InvokeOperation(Of GlobalNamespaceTest_Enum)
            ...
            parameters.Add("enumParameter", enumParameter)
            Me.ValidateMethod("InvokeReturn", parameters)
            Return CType(Me.InvokeOperation("InvokeReturn", GetType(GlobalNamespaceTest_Enum), parameters, true, Nothing, Nothing),InvokeOperation(Of GlobalNamespaceTest_Enum))
        End Function
        ...
        Public Interface IGlobalNamespaceTest_DomainServiceContract
            ...
            <FaultContract(GetType(DomainServiceFault), Action:="http://tempuri.org/GlobalNamespaceTest_DomainService/GetEntitiesDomainServiceFaul"& _ 
            ...
            ''' <param name="asyncState">Optional state object.</param>
            ''' <returns>An IAsyncResult that can be used to monitor the request.</returns>
            <FaultContract(GetType(DomainServiceFault), Action:="http://tempuri.org/GlobalNamespaceTest_DomainService/InvokeReturnDomainServiceFau"& _ 
            ...
            ''' <param name="asyncState">Optional state object.</param>
            ''' <returns>An IAsyncResult that can be used to monitor the request.</returns>
            <FaultContract(GetType(DomainServiceFault), Action:="http://tempuri.org/GlobalNamespaceTest_DomainService/InvokeVoidDomainServiceFault"& _ 
            ...
            ''' <param name="asyncState">Optional state object.</param>
            ''' <returns>An IAsyncResult that can be used to monitor the request.</returns>
            <FaultContract(GetType(DomainServiceFault), Action:="http://tempuri.org/GlobalNamespaceTest_DomainService/ReadEntitiesDomainServiceFau"& _ 
                "lt", Name:="DomainServiceFault", [Namespace]:="DomainServices"),  _
            ...
            ''' <param name="asyncState">Optional state object.</param>
            ''' <returns>An IAsyncResult that can be used to monitor the request.</returns>
            <FaultContract(GetType(DomainServiceFault), Action:="http://tempuri.org/GlobalNamespaceTest_DomainService/SubmitChangesDomainServiceFa"& _ 
