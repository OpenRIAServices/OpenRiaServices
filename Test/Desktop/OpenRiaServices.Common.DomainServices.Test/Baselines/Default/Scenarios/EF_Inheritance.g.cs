...
namespace DataTests.Inheritance.EF
{
    ...
    public sealed partial class EF_Inheritance_DomainContext : DomainContext
    {
        ...
        public EF_Inheritance_DomainContext() : 
                this(new Uri("DataTests-Inheritance-EF-EF_Inheritance_DomainService.svc", UriKind.Relative))
        {
        }
        ...
        public EF_Inheritance_DomainContext(Uri serviceUri) : 
                this(DomainContext.CreateDomainClient(typeof(IEF_Inheritance_DomainServiceContract), serviceUri, false))
        {
        }
