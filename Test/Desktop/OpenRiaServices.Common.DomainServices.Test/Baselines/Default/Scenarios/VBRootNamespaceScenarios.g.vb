...
Partial Public NotInheritable Class VBRootNamespaceTestDomainContext
    ...
    ''' </summary>
    Public Sub New()
        Me.New(New Uri("VBRootNamespaceTest-VBRootNamespaceTestDomainService.svc", UriKind.Relative))
    End Sub
    ...
    Public Sub New(ByVal serviceUri As Uri)
        Me.New(DomainContext.CreateDomainClient(GetType(IVBRootNamespaceTestDomainServiceContract), serviceUri, false))
    End Sub
...
Namespace Inner
    ...
    Partial Public NotInheritable Class VBRootNamespaceTestProviderInsideInner
        ...
        ''' </summary>
        Public Sub New()
            Me.New(New Uri("VBRootNamespaceTest-Inner-VBRootNamespaceTestProviderInsideInner.svc", UriKind.Relative))
        End Sub
        ...
        Public Sub New(ByVal serviceUri As Uri)
            Me.New(DomainContext.CreateDomainClient(GetType(IVBRootNamespaceTestProviderInsideInnerContract), serviceUri, false))
        End Sub
...
Namespace VBRootNamespaceTest2
    ...
    Partial Public NotInheritable Class VBRootNamespaceTestDomainService2
        ...
        ''' </summary>
        Public Sub New()
            Me.New(New Uri("VBRootNamespaceTest2-VBRootNamespaceTestDomainService2.svc", UriKind.Relative))
        End Sub
        ...
        Public Sub New(ByVal serviceUri As Uri)
            Me.New(DomainContext.CreateDomainClient(GetType(IVBRootNamespaceTestDomainService2Contract), serviceUri, false))
        End Sub
