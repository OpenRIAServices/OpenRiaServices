...
<head runat="server">
    <title>$safeclientprojectname$</title>
    <style type="text/css">
    html, body {
	    height: 100%;
	    overflow: auto;
...
<body>
    ...
    <div id="silverlightControlHost">
        <object data="data:application/x-silverlight-2," type="application/x-silverlight-2" width="100%" height="100%">
		  <param name="source" value="ClientBin/$safeclientprojectname$.xap"/>
		  ...
		  <a href="http://go.microsoft.com/fwlink/?LinkID=149156&v=$runtime_version$" style="text-decoration:none">
