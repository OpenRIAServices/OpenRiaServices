...
[assembly: SuppressMessage("Microsoft.Design", "CA1033:InterfaceMethodsShouldBeCallableByChildTypes", Scope = "member", Target = "OpenRiaServices.Server.ApplicationServices.UserBase.#System.Security.Principal.IPrincipal.Identity", Justification = "Low use so explicitly withheld from the API")]
[assembly: SuppressMessage("Microsoft.Design", "CA1033:InterfaceMethodsShouldBeCallableByChildTypes", Scope = "member", Target = "OpenRiaServices.Server.ApplicationServices.UserBase.#System.Security.Principal.IIdentity.AuthenticationType", Justification = "Low use so explicitly withheld from the API")]
