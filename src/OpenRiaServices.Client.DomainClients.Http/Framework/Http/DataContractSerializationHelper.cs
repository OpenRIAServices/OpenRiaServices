...
namespace OpenRiaServices.Client.DomainClients.Http
{
    ...
    {       
        ...
        /// <summary>
        /// Initializes a new instance of DataContractSerializationHelper for the specified service interface.
        /// </summary>
        /// <param name="serviceInterface">The service interface Type whose operations and entity types the helper will inspect and cache for serialization.</param>
