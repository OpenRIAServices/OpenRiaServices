...
{
    /// <summary>
    /// Task that validates the integrity of the <see cref="OpenRiaServices.Server.DomainService"/>s exposed by the target Web Application
    /// </summary>
    public class ValidateDomainServicesTask : Task
    {
        ...
        /// <summary>
        /// Gets or sets the assembly containing <see cref="OpenRiaServices.Server.DomainService"/> types
        /// </summary>
        [Required]
        public ITaskItem Assembly { get; set; }

        /// <summary>
        /// Gets or sets the list of reference assemblies that may contains <see cref="OpenRiaServices.Server.DomainService"/> types
        /// </summary>
        [Required]
        ...
        /// <summary>
        /// Validates the integrity of the <see cref="OpenRiaServices.Server.DomainService"/>s exposed by the target Web Application
