...
namespace OpenRiaServices.Tools.Test.T4Generator
{
    ...
    public partial class T4DomainServiceClientCodeGenerator : IDomainServiceClientCodeGenerator
    {
        ...
        public string GenerateCode(ICodeGenerationHost host, IEnumerable<OpenRiaServices.Server.DomainServiceDescription> domainServiceDescriptions, ClientCodeGenerationOptions options)
        {
