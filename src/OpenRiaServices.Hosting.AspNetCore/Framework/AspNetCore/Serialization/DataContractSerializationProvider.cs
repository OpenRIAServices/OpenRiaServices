...
namespace OpenRiaServices.Hosting.AspNetCore.Serialization
{
    ...
    {
        /// <summary>
            /// Creates a Binary-XML DataContract request serializer for the specified domain operation.
            /// </summary>
    ...
    {
        /// <summary>
            /// Creates a Text XML data-contract request serializer for the specified domain operation.
            /// </summary>
    ...
    internal abstract class DataContractSerializationProvider() : ISerializationProvider
    {
        ...
        /// <summary>
/// Create a DataContractRequestSerializer for the specified domain operation using the provided data contract cache.
/// </summary>
