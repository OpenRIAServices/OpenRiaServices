...
namespace OpenRiaServices.Hosting.AspNetCore.Serialization
{
    internal class DataContractCache
    {
        ...
        /// <summary>
        /// Initializes a new DataContractCache for the specified domain service description.
        /// </summary>
        /// <param name="domainServiceDescription">The domain service description whose operations and complex-type metadata are used to determine known types and to create the serialization surrogate provider.</param>
        ...
        /// 
        /// <summary>
        /// Gets a DataContractSerializer configured for the specified type.
        /// </summary>
        /// <param name="type">The runtime type to serialize.</param>
        /// <returns>A <see cref="DataContractSerializer"/> configured to serialize instances of the specified type; may include known types and a serialization surrogate provider where applicable.</returns>
