...
Namespace TestNamespace
    ...
    Partial Public NotInheritable Class AuthenticationService2
        ...
        ''' </summary>
        Public Sub New()
            Me.New(New Uri("RootNamespace-TestNamespace-AuthenticationService2.svc", UriKind.Relative))
        End Sub
        ...
        Public Sub New(ByVal serviceUri As Uri)
            Me.New(DomainContext.CreateDomainClient(GetType(IAuthenticationService2Contract), serviceUri, false))
        End Sub
