...
Namespace SharedEntities
    ...
    Partial Public NotInheritable Class EntityA
        ...
        ''' </summary>
        <EntityAction("UpdateAThroughChild", AllowMultipleInvocations:=false)>  _
        ...
        ''' </summary>
        <EntityAction("UpdateAThroughParent", AllowMultipleInvocations:=false)>  _
    ...
    Partial Public NotInheritable Class ExposeChildEntityDomainContext
        ...
        ''' </summary>
        Public Sub New()
            Me.New(New Uri("SharedEntities-ExposeChildEntityDomainService.svc", UriKind.Relative))
        End Sub
        ...
        Public Sub New(ByVal serviceUri As Uri)
            Me.New(DomainContext.CreateDomainClient(GetType(IExposeChildEntityDomainServiceContract), serviceUri, false))
        End Sub
    ...
    Partial Public NotInheritable Class ExposeParentEntityDomainContext
        ...
        ''' </summary>
        Public Sub New()
            Me.New(New Uri("SharedEntities-ExposeParentEntityDomainService.svc", UriKind.Relative))
        End Sub
        ...
        Public Sub New(ByVal serviceUri As Uri)
            Me.New(DomainContext.CreateDomainClient(GetType(IExposeParentEntityDomainServiceContract), serviceUri, false))
        End Sub
