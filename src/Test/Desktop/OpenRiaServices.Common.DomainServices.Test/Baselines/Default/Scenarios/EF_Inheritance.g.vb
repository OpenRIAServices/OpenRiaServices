...
Namespace DataTests.Inheritance.EF
    ...
    Partial Public NotInheritable Class EF_Inheritance_DomainContext
        ...
        ''' </summary>
        Public Sub New()
            Me.New(New Uri("DataTests-Inheritance-EF-EF_Inheritance_DomainService.svc", UriKind.Relative))
        End Sub
        ...
        Public Sub New(ByVal serviceUri As Uri)
            Me.New(DomainContext.CreateDomainClient(GetType(IEF_Inheritance_DomainServiceContract), serviceUri, false))
        End Sub
