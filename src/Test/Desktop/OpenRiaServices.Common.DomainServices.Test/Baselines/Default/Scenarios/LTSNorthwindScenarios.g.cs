...
namespace DataTests.Scenarios.LTS.Northwind
{
    ...
    public sealed partial class LTS_NorthwindScenarios : DomainContext
    {
        ...
        public LTS_NorthwindScenarios() : 
                this(new Uri("DataTests-Scenarios-LTS-Northwind-LTS_NorthwindScenarios.svc", UriKind.Relative))
        {
        }
        ...
        public LTS_NorthwindScenarios(Uri serviceUri) : 
                this(DomainContext.CreateDomainClient(typeof(ILTS_NorthwindScenariosContract), serviceUri, false))
        {
        }
