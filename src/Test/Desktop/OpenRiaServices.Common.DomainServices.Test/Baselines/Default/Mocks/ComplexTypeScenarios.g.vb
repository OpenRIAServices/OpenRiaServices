...
Namespace TestDomainServices
    ...
    Partial Public NotInheritable Class ComplexTypes_InvokeOperationsOnly
        ...
        ''' <param name="userState">Value to pass to the callback.  It can be <c>null</c>.</param>
        ''' <returns>An operation instance that can be used to manage the asynchronous request.</returns>
        Public Overloads Function InvokeGetInvalidAddress(ByVal callback As Action(Of InvokeOperation(Of Address)), ByVal userState As Object) As InvokeOperation(Of Address)
            Me.ValidateMethod("InvokeGetInvalidAddress", Nothing)
            Return Me.InvokeOperation(Of Address)("InvokeGetInvalidAddress", GetType(Address), Nothing, true, callback, userState)
        End Function
        ...
        ''' </summary>
        ''' <returns>An operation instance that can be used to manage the asynchronous request.</returns>
        Public Overloads Function InvokeGetInvalidAddress() As InvokeOperation(Of Address)
            Me.ValidateMethod("InvokeGetInvalidAddress", Nothing)
            Return Me.InvokeOperation(Of Address)("InvokeGetInvalidAddress", GetType(Address), Nothing, true, Nothing, Nothing)
        End Function
        ...
        ''' <param name="cancellationToken">A cancellation token that can be used to cancel the work</param>
        ''' <returns>An operation instance that can be used to manage the asynchronous request.</returns>
        Public Function InvokeGetInvalidAddressAsync(Optional ByVal cancellationToken As CancellationToken = Nothing) As System.Threading.Tasks.Task(Of InvokeResult(Of Address))
            Me.ValidateMethod("InvokeGetInvalidAddress", Nothing)
            Return Me.InvokeOperationAsync(Of Address)("InvokeGetInvalidAddress", Nothing, true, cancellationToken)
        End Function
        ...
        Public Interface IComplexTypes_InvokeOperationsOnlyContract
            ...
            Function EndInvokeGetInvalidAddress(ByVal result As IAsyncResult) As Address
