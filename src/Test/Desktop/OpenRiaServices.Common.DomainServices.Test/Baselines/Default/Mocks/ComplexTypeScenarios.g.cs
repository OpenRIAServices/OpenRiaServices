...
namespace TestDomainServices
{
    ...
    public sealed partial class ComplexTypes_InvokeOperationsOnly : DomainContext
    {
        ...
        /// <param name="userState">Value to pass to the callback.  It can be <c>null</c>.</param>
        /// <returns>An operation instance that can be used to manage the asynchronous request.</returns>
        public InvokeOperation<Address> InvokeGetInvalidAddress(Action<InvokeOperation<Address>> callback, object userState)
        {
            this.ValidateMethod("InvokeGetInvalidAddress", null);
            return this.InvokeOperation<Address>("InvokeGetInvalidAddress", typeof(Address), null, true, callback, userState);
        }
        ...
        /// </summary>
        /// <returns>An operation instance that can be used to manage the asynchronous request.</returns>
        public InvokeOperation<Address> InvokeGetInvalidAddress()
        {
            this.ValidateMethod("InvokeGetInvalidAddress", null);
            return this.InvokeOperation<Address>("InvokeGetInvalidAddress", typeof(Address), null, true, null, null);
        }
        ...
        /// <param name="cancellationToken">A cancellation token that can be used to cancel the work</param>
        /// <returns>An operation instance that can be used to manage the asynchronous request.</returns>
        public System.Threading.Tasks.Task<InvokeResult<Address>> InvokeGetInvalidAddressAsync(CancellationToken cancellationToken = default(CancellationToken))
        {
            this.ValidateMethod("InvokeGetInvalidAddress", null);
            return this.InvokeOperationAsync<Address>("InvokeGetInvalidAddress", null, true, cancellationToken);
        }
    ...
    public sealed partial class ComplexTypes_TestContext : DomainContext
    {
        ...
        /// <returns>An EntityQuery that can be loaded to retrieve <see cref="ComplexType_Parent"/> entity instances.</returns>
        public EntityQuery<ComplexType_Parent> GetParentsByHomeAddressQuery(Address address)
        {
            Dictionary<string, object> parameters = new Dictionary<string, object>();
            parameters.Add("address", address);
            this.ValidateMethod("GetParentsByHomeAddressQuery", parameters);
            return base.CreateQuery<ComplexType_Parent>("GetParentsByHomeAddress", parameters, false, true);
        }
        ...
        public interface IComplexTypes_TestServiceContract
        {
            ...
            /// <returns>An IAsyncResult that can be used to monitor the request.</returns>
            [HasSideEffects(false)]
            IAsyncResult BeginGetParentsByHomeAddress(Address address, AsyncCallback callback, object asyncState);
            ...
            QueryResult<ComplexType_Parent> EndGetParentsByHomeAddress(IAsyncResult result);
