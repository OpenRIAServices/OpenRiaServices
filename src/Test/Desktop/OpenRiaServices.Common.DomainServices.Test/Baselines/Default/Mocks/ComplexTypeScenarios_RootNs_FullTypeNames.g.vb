...
Namespace TestDomainServices
    ...
    Partial Public NotInheritable Class ComplexTypes_InvokeOperationsOnly
        ...
        ''' <summary>
        ''' Asynchronously invokes the 'InvokeGetInvalidAddress' method of the DomainService.
        ''' </summary>
        ''' <param name="callback">Callback to invoke when the operation completes.</param>
        ''' <param name="userState">Value to pass to the callback.  It can be <c>null</c>.</param>
        ''' <returns>An operation instance that can be used to manage the asynchronous request.</returns>
        Public Overloads Function InvokeGetInvalidAddress(ByVal callback As Global.System.Action(Of Global.OpenRiaServices.Client.InvokeOperation(Of Global.RootNamespaceName.TestDomainServices.Address)), ByVal userState As Object) As Global.OpenRiaServices.Client.InvokeOperation(Of Global.RootNamespaceName.TestDomainServices.Address)
            Me.ValidateMethod("InvokeGetInvalidAddress", Nothing)
            Return Me.InvokeOperation(Of Global.RootNamespaceName.TestDomainServices.Address)("InvokeGetInvalidAddress", GetType(Global.RootNamespaceName.TestDomainServices.Address), Nothing, true, callback, userState)
        End Function
        ...
        ''' </summary>
        ''' <returns>An operation instance that can be used to manage the asynchronous request.</returns>
        Public Overloads Function InvokeGetInvalidAddress() As Global.OpenRiaServices.Client.InvokeOperation(Of Global.RootNamespaceName.TestDomainServices.Address)
            Me.ValidateMethod("InvokeGetInvalidAddress", Nothing)
            Return Me.InvokeOperation(Of Global.RootNamespaceName.TestDomainServices.Address)("InvokeGetInvalidAddress", GetType(Global.RootNamespaceName.TestDomainServices.Address), Nothing, true, Nothing, Nothing)
        End Function
        ...
        ''' <param name="cancellationToken">A cancellation token that can be used to cancel the work</param>
        ''' <returns>An operation instance that can be used to manage the asynchronous request.</returns>
        Public Function InvokeGetInvalidAddressAsync(Optional ByVal cancellationToken As Global.System.Threading.CancellationToken = Nothing) As Global.System.Threading.Tasks.Task(Of Global.OpenRiaServices.Client.InvokeResult(Of Global.RootNamespaceName.TestDomainServices.Address))
            Me.ValidateMethod("InvokeGetInvalidAddress", Nothing)
            Return Me.InvokeOperationAsync(Of Global.RootNamespaceName.TestDomainServices.Address)("InvokeGetInvalidAddress", Nothing, true, cancellationToken)
        End Function
        ...
        Public Interface IComplexTypes_InvokeOperationsOnlyContract
            ...
            Function EndInvokeGetInvalidAddress(ByVal result As Global.System.IAsyncResult) As Global.RootNamespaceName.TestDomainServices.Address
    ...
    Partial Public NotInheritable Class ComplexTypes_TestContext
        ...
        ''' <returns>An EntityQuery that can be loaded to retrieve <see cref="ComplexType_Parent"/> entity instances.</returns>
        Public Function GetParentsByHomeAddressQuery(ByVal address As Global.RootNamespaceName.TestDomainServices.Address) As Global.OpenRiaServices.Client.EntityQuery(Of Global.RootNamespaceName.TestDomainServices.ComplexType_Parent)
            Dim parameters As Global.System.Collections.Generic.Dictionary(Of String, Object) = New Global.System.Collections.Generic.Dictionary(Of String, Object)()
            parameters.Add("address", address)
            Me.ValidateMethod("GetParentsByHomeAddressQuery", parameters)
            Return MyBase.CreateQuery(Of Global.RootNamespaceName.TestDomainServices.ComplexType_Parent)("GetParentsByHomeAddress", parameters, false, true)
        End Function
        ...
        Public Interface IComplexTypes_TestServiceContract
            ...
            ''' <returns>An IAsyncResult that can be used to monitor the request.</returns>
            <Global.OpenRiaServices.Client.HasSideEffects(false)>  _
            Function BeginGetParentsByHomeAddress(ByVal address As Global.RootNamespaceName.TestDomainServices.Address, ByVal callback As Global.System.AsyncCallback, ByVal asyncState As Object) As Global.System.IAsyncResult
            ...
            Function EndGetParentsByHomeAddress(ByVal result As Global.System.IAsyncResult) As Global.OpenRiaServices.Client.QueryResult(Of Global.RootNamespaceName.TestDomainServices.ComplexType_Parent)
