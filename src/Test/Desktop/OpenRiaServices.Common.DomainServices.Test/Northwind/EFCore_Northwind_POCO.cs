...
using NorthwindEFCorePOCOModel;
...
namespace TestDomainServices.EFCore
{
    ...
    /// </summary>
    [EnableClientAccess]
    public class EFCoreNorthwindPOCO : LinqToEntitiesDomainServiceEFCore<NorthwindEntities>
    {
        #region Product methods
        public Product GetProductById(int id)
        {
            return this.GetProducts().SingleOrDefault(p => p.ProductID == id);
        }
    ...
    public class NorthwindPOCO_CUD : EFCoreNorthwindPOCO
    {
        // TODo
