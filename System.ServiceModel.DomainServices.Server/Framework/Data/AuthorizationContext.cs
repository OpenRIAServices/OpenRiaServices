...
namespace System.ComponentModel.DataAnnotations
{
    ...
    public sealed class AuthorizationContext : IServiceProvider, IDisposable
    {
        ...
        /// </para>
        /// <para>
        /// The <see cref="System.ServiceModel.DomainServices.Server.DomainService.AuthorizationContext"/> 
        /// property allows such a template to be set into the
        /// <see cref="System.ServiceModel.DomainServices.Server.DomainService"/> for all authorization requests.
        /// </para>
        /// </remarks>
