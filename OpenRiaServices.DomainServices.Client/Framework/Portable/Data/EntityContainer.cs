...
namespace OpenRiaServices.DomainServices.Client
{
    ...
    public abstract class EntityContainer : IRevertibleChangeTracking, INotifyPropertyChanged
    {
        ...
        public EntityChangeSet GetChanges()
        {
            ...
            EntityChangeSet changeSet = new EntityChangeSet(new ReadOnlyCollection<Entity>(addedEntities), new ReadOnlyCollection<Entity>(modifiedEntities), new ReadOnlyCollection<Entity>(removedEntities));
