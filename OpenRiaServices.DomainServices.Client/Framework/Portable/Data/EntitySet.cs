...
namespace OpenRiaServices.DomainServices.Client
{
    ...
    public abstract class EntitySet : IEnumerable, INotifyCollectionChanged, IRevertibleChangeTracking, INotifyPropertyChanged
    {
        ...
        internal ReadOnlyCollection<Entity> InterestingEntities
        {
            get
            {
                ...
                return new ReadOnlyCollection<Entity>(this._interestingEntities);
            }
        }
    ...
    public sealed class EntitySet<TEntity> : EntitySet, IEnumerable<TEntity> where TEntity : Entity
    {
        /// <summary>
