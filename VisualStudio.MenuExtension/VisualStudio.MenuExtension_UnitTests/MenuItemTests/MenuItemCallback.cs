...
using Company.VisualStudio_MenuExtension;

namespace VisualStudio.MenuExtension_UnitTests.MenuItemTests
{
    [TestClass()]
    public class MenuItemTest
    {
        ...
        {
            // Create the package
            IVsPackage package = new VisualStudio_MenuExtensionPackage() as IVsPackage;
            ...
            CommandID menuCommandID = new CommandID(Company.VisualStudio_MenuExtension.GuidList.guidVisualStudio_MenuExtensionCmdSet, (int)Company.VisualStudio_MenuExtension.PkgCmdIDList.cmdidLinkOpenRiaServicesProject);
