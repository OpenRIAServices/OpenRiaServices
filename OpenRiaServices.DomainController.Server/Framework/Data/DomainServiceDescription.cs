...
{
    /// <summary>
    /// This class provides a metadata description of a <see cref="DomainController"/> and the
    /// types and operations it exposes.
    /// </summary>
    public sealed class DomainControllerDescription
    {
        private static readonly ConcurrentDictionary<Type, DomainControllerDescription> DomainControllerMap = new ConcurrentDictionary<Type, DomainControllerDescription>();
        ...
        private DomainControllerDescriptionProvider _descriptionProvider;

        /// <summary>
        /// Constructs a description for the specified <see cref="DomainController"/> Type.
        /// </summary>
        /// <param name="DomainControllerType">The Type of the DomainController</param>
        internal DomainControllerDescription(Type DomainControllerType)
        {
        ...
        /// <summary>
        /// Constructs a description based on the specified <see cref="DomainControllerDescription"/>.
        /// </summary>
        /// <param name="baseDescription">The base <see cref="DomainControllerDescription"/></param>
        internal DomainControllerDescription(DomainControllerDescription baseDescription)
        {
            ...
            this._DomainControllerType = baseDescription._DomainControllerType;
        ...
        /// <summary>
        /// Gets the complex types exposed by the <see cref="DomainController"/>
        /// </summary>
        ...
        /// </summary>
        public Type DomainControllerType
        {
            get
            {
                return this._DomainControllerType;
            }
        }
        ...
        /// <summary>
        /// Gets all the root entity types exposed by the <see cref="DomainController"/>
        /// </summary>
        /// <remarks>A 'root entity type' is the least derived entity type within an
        /// entity hierarchy exposed by a <see cref="DomainController"/>.  It need not be the
        ...
        /// <summary>
        /// Gets the collection of <see cref="DomainOperationEntry"/> items for the <see cref="DomainController"/>.
        /// </summary>
        ...
        /// <summary>
        /// Gets or sets a collection of attributes for <see cref="DomainController"/> Type.
        /// </summary>
        ...
        /// </summary>
        /// <remarks>
        /// This method can only be called during construction of the <see cref="DomainControllerDescription"/> before
        /// it has been completely initialized. This is done in advanced extensibility scenarios involving custom
        /// <see cref="DomainControllerDescriptionProvider"/>s.
        /// </remarks>
        ...
        public void AddOperation(DomainOperationEntry operation)
        {
            ...
            if (operation.DomainControllerType != this.DomainControllerType)
            {
                throw new ArgumentException(string.Format(CultureInfo.CurrentCulture, Resource.DomainControllerDescription_IncompatibleOperationParentType, operation.Name, this.DomainControllerType, operation.DomainControllerType), "operation");
            }
        ...
        /// <summary>
        /// Returns the <see cref="DomainController"/> query method of the specified name
        /// </summary>
        ...
        /// <summary>
        /// Returns the <see cref="DomainController"/> invoke operation of the specified name.
        /// </summary>
        ...
        /// <summary>
        /// Returns the <see cref="DomainController"/> custom method of the specified name associated with the specified entity type
        /// </summary>
        ...
        /// Type exposed by the <see cref="DomainController"/>, taking inheritance into account.
        /// </summary>
        ...
        /// <returns>The corresponding type exposed by the DomainController, or null
        /// if the specified type is not exposed by the DomainController.</returns>
        ...
        /// hierarchy that is exposed through a <see cref="DomainController"/>.
        /// </remarks>
        ...
        /// <see cref="DomainController"/>. The entity hierarchy
        ...
        /// <summary>
        /// Returns the <see cref="DomainControllerDescription"/> for the specified <see cref="DomainController"/> Type.
        /// </summary>
        /// <param name="DomainControllerType">The Type of <see cref="DomainController"/> to get description for</param>
        /// <returns>The description for the specified <see cref="DomainController"/> type</returns>
        public static DomainControllerDescription GetDescription(Type DomainControllerType)
        {
            if (DomainControllerType == null)
            {
                throw new ArgumentNullException("DomainControllerType");
            ...
            if (DomainControllerType.IsAbstract
                || DomainControllerType.IsGenericType
                || DomainControllerType.IsGenericTypeDefinition
                || !typeof(DomainController).IsAssignableFrom(DomainControllerType))
            {
                throw new InvalidOperationException(string.Format(CultureInfo.CurrentCulture, Resource.DomainController_InvalidType, DomainControllerType.FullName));
            }

            return DomainControllerMap.GetOrAdd(DomainControllerType, type =>
            {
                return CreateDescription(DomainControllerType);
            });
        }
        ...
        private void CheckInvalidUpdate()
        {
            if (this._isInitialized)
            {
                throw new InvalidOperationException(string.Format(CultureInfo.CurrentCulture, Resource.DomainControllerDescription_InvalidUpdate));
            }
        }
        ...
        private void EnsureInitialized()
        {
            ...
            {
                throw new InvalidOperationException(string.Format(CultureInfo.CurrentCulture, Resource.DomainControllerDescription_Uninitialized));
            }
        }
        ...
        private static DomainControllerDescription CreateDescription(Type DomainControllerType)
        {
            DomainControllerDescriptionProvider descriptionProvider = CreateDescriptionProvider(DomainControllerType);
            DomainControllerDescription description = descriptionProvider.GetDescription();
        ...
        /// </summary>
        /// <param name="DomainControllerType">The domain service Type.</param>
        /// <returns>The description provider.</returns>
        internal static DomainControllerDescriptionProvider CreateDescriptionProvider(Type DomainControllerType)
        {
            ...
            List<DomainControllerDescriptionProvider> descriptionProviderList = new List<DomainControllerDescriptionProvider>();
            ReflectionDomainControllerDescriptionProvider reflectionDescriptionProvider = new ReflectionDomainControllerDescriptionProvider(DomainControllerType);
            ...
            // their DomainController directly come before an DAL providers.
            DomainControllerDescriptionProvider currProvider = reflectionDescriptionProvider;
            ...
            for (int i = 0; i < baseTypes.Count; i++)
            {
                ...
                foreach (DomainControllerDescriptionProviderAttribute providerAttribute in
                    currType.GetCustomAttributes(typeof(DomainControllerDescriptionProviderAttribute), false))
                {
        ...
        private static void RegisterDomainTypeDescriptionProvider(Type type, DomainControllerDescriptionProvider descriptionProvider)
        {
        ...
        private void ValidateComplexTypes()
        {
            foreach (Type complexType in this.ComplexTypes)
            {
                ...
                {
                    throw new InvalidOperationException(string.Format(CultureInfo.CurrentCulture, Resource.InvalidComplexType_Inheritance, this.DomainControllerType, childComplexType, complexType));
                }
                ...
                {
                    throw new InvalidOperationException(string.Format(CultureInfo.CurrentCulture, Resource.InvalidComplexType_EntityInheritance, this.DomainControllerType, childEntityType, complexType));
                }
            }
        }
                ...
                if (pd.Attributes[typeof(CompositionAttribute)] != null)
                {
                    if (pd.Attributes[typeof(AssociationAttribute)] == null)
                    {
                        throw new InvalidOperationException(
                            string.Format(CultureInfo.CurrentCulture, Resource.DomainControllerDescription_InvalidCompositionMember, pd.ComponentType, pd.Name));
                    }
            ...
            foreach (Type entityType in this._entityTypes)
            {
                ...
                foreach (PropertyDescriptor pd in pds)
                {
                    ...
                    if (pd.Attributes[typeof(TimestampAttribute)] != null && pd.Attributes[typeof(ConcurrencyCheckAttribute)] != null)
                    {
                        ...
                        {
                            throw new InvalidOperationException(string.Format(CultureInfo.CurrentCulture, Resource.DomainControllerDescription_MultipleVersionMembers, entityType));
                        }
                        versionMember = pd;
                    }
                }
                ...
                {
                    throw new InvalidOperationException(string.Format(CultureInfo.CurrentCulture, Resource.Entity_Has_No_Key_Properties, entityType.Name, this._DomainControllerType.Name));
                }
                ...
                DomainControllerDescription.ValidatePropertyPolymorphism(entityType);
        ...
        private void ValidateKnownTypeAttribute(Type entityType, bool mustSpecifyAll)
        {
            ...
            {
                throw new InvalidOperationException(string.Format(CultureInfo.CurrentCulture, Resource.KnownTypeAttributeRequired_Abstract, entityType.Name, this.DomainControllerType.Name));
            }
        ...
        private static void ValidateDataContractAttribute(Type entityType)
        {
            ...
            while (baseType != null)
            {
                ...
                {
                    throw new InvalidOperationException(string.Format(CultureInfo.CurrentCulture, Resource.DomainControllerDescription_DataContractAttributeRequired, entityType.Name, baseType.Name));
                }
                baseType = baseType.BaseType;
            }
        }
        ...
        private void AddSubmitMethod(DomainOperationEntry method)
        {
            ...
            {
                throw new InvalidOperationException(string.Format(CultureInfo.CurrentCulture, Resource.DomainController_DuplicateCUDMethod, methodName, entitySubmitMethods[method.Operation].Name));
            }
        ...
        private void ValidateDefaultQuery(DomainOperationEntry method)
        {
            ...
            {
                throw new InvalidOperationException(string.Format(CultureInfo.CurrentCulture, Resource.DomainControllerDescription_DefaultQuery_Cannot_Have_Params, method.Name));
            }

            // Extract the (logical) entity type returned by this query, factoring out whether it is singleton or IEnumerable.
            bool isSingleton = false;
            Exception error = null;
            Type entityType = DomainControllerDescription.GetQueryEntityReturnType(method, out isSingleton, out error);
            if (error != null)
            {
                throw error;
            }
            ...
            if (isSingleton)
            {
                throw new InvalidOperationException(string.Format(CultureInfo.CurrentCulture, Resource.DomainControllerDescription_DefaultQuery_Cannot_Be_Singleton, method.Name));
            }
            ...
            foreach (DomainOperationEntry existingQuery in this._queryMethods.Values)
            {
                ...
                if (queryAttribute != null && queryAttribute.IsDefault)
                {
                    Type existingEntityType = DomainControllerDescription.GetQueryEntityReturnType(existingQuery, out isSingleton, out error);

                    // Two default queries returning the same type is not legal
                    if (existingEntityType == entityType)
                    {
                        throw new InvalidOperationException(string.Format(CultureInfo.CurrentCulture, Resource.DomainControllerDescription_DefaultQuery_Cannot_Have_Multiple, method.Name, existingQuery.Name, entityType));
                    }
                    ...
                    {
                        throw new InvalidOperationException(string.Format(CultureInfo.CurrentCulture, Resource.DomainControllerDescription_DefaultQuery_Cannot_Have_Multiple_Inheritance, method.Name, existingQuery.Name, entityType, existingEntityType));
                    }
                    if (entityType.IsAssignableFrom(existingEntityType))
                    {
                        throw new InvalidOperationException(string.Format(CultureInfo.CurrentCulture, Resource.DomainControllerDescription_DefaultQuery_Cannot_Have_Multiple_Inheritance, method.Name, existingQuery.Name, existingEntityType, entityType));
                    }
                }
            }
        }

        private static void ValidateMethodSignature(DomainControllerDescription description, DomainOperationEntry method)
        {
            Exception error;
        ...
        private static bool IsValidMethodSignature(DomainControllerDescription description, DomainOperationEntry operationEntry, DomainOperation operation, out Exception error)
        {
                ...
                case DomainOperation.Query:
                    {
                        ...
                        bool isSingleton = false;
                        Type entityType = DomainControllerDescription.GetQueryEntityReturnType(operationEntry, out isSingleton, out error);
                        if (error != null)
                        {
                            return false;
                        }
                        ...
                        {
                            throw new InvalidOperationException(string.Format(CultureInfo.CurrentCulture, Resource.DomainControllerDescription_SingletonQueryMethodCannotCompose, methodName, returnType));
                        }
