...
{
    /// <summary>
    /// Represents the execution context for a <see cref="DomainController"/> request.
    /// </summary>
    public class DomainControllerContext : IServiceProvider
    {
        ...
        /// <summary>
        /// Initializes a new instance of the DomainControllerContext class
        /// </summary>
        /// <param name="serviceProvider">A service provider.</param>
        /// <param name="operationType">The type of operation that is being executed.</param>
        public DomainControllerContext(IServiceProvider serviceProvider, DomainOperationType operationType)
        {
        ...
        /// <param name="operationType">The type of operation that is being executed.</param>
        internal DomainControllerContext(DomainControllerContext serviceContext, DomainOperationType operationType)
        {
        ...
        /// <see cref="IServiceProvider"/> provided to this <see cref="DomainControllerContext"/>
        ...
        internal IServiceContainer ServiceContainer
        {
            get
            {
                if (this._serviceContainer == null)
                {
                    this._serviceContainer = new DomainControllerContextServiceContainer();
                }
        ...
        /// as a default service container on <see cref="DomainControllerContext"/>.
        /// </summary>
        private class DomainControllerContextServiceContainer : IServiceContainer
        {
            ...
            /// </summary>
            internal DomainControllerContextServiceContainer()
            {
            }
            ...
            internal DomainControllerContextServiceContainer(IServiceContainer parentContainer)
            {
            ...
            public void AddService(Type serviceType, ServiceCreatorCallback callback, bool promote)
            {
                ...
                else
                {
                    lock (this._lock)
                    {
                        ...
                        {
                            throw new ArgumentException(string.Format(CultureInfo.CurrentCulture, Resource.DomainControllerContextServiceContainer_ItemAlreadyExists, serviceType), "serviceType");
                        }
