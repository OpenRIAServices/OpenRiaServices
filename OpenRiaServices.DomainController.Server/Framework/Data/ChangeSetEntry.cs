...
namespace OpenRiaServices.DomainController.Server
{
    ...
    /// type passed between DomainClient and <see cref="DomainController"/> both for sending operations to
    /// the <see cref="DomainController"/> as well as for returning operation results back to the DomainClient.
    /// </summary>
