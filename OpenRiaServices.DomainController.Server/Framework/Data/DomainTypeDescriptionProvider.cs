...
namespace OpenRiaServices.DomainController.Server
{
    ...
    {
        private DomainControllerDescriptionProvider _descriptionProvider = null;
        private ICustomTypeDescriptor _customTypeDescriptor = null; 
        private Type _type;

        public DomainTypeDescriptionProvider(Type type, DomainControllerDescriptionProvider descriptionProvider)
        ...
        public override ICustomTypeDescriptor GetTypeDescriptor(Type objectType, object instance)
        {
            ...
            if (this._customTypeDescriptor == null)
            {
                ...
                // EF, any other custom type descriptors provided through DomainControllerDescriptionProviders.
