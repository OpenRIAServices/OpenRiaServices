...
namespace System.ComponentModel.DataAnnotations
{
    ...
    public sealed class AuthorizationContext : IServiceProvider, IDisposable
    {
        ...
        /// </para>
        /// <para>
        /// The <see cref="OpenRiaServices.DomainController.Server.DomainController.AuthorizationContext"/> 
        /// property allows such a template to be set into the
        /// <see cref="OpenRiaServices.DomainController.Server.DomainController"/> for all authorization requests.
        /// </para>
        /// </remarks>
