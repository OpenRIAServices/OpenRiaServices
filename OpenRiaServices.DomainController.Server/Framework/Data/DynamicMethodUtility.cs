...
namespace OpenRiaServices.DomainController.Server
{
    internal static class DynamicMethodUtility
    {
        ...
        /// <code>
        /// public object &lt;MethodName&gt;(DomainController target, object[] parameters) {
        ...
        public static Func<DomainController, object[], object> GetDelegateForMethod(MethodInfo method)
        {
            return (Func<DomainController, object[], object>)GetDynamicMethod(method).CreateDelegate(typeof(Func<DomainController, object[], object>));
        }
        ...
        private static DynamicMethod GetDynamicMethod(MethodInfo method)
        {
            ...
            {
                parameterTypes = new Type[] { typeof(DomainController), typeof(object[]) };
            }
