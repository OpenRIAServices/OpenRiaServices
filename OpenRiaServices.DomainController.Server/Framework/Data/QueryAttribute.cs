...
{
    /// <summary>
    /// Attribute applied to a <see cref="DomainController"/> method to indicate that it is a query method.
    /// </summary>
    [AttributeUsage(
    ...
    public sealed class QueryAttribute : Attribute
    {
        ...
        /// </summary>
        /// <remarks>
        /// Queries with side-effects may be invoked differently by consumers of a <see cref="DomainController"/>. For example, 
        /// clients that invoke a <see cref="DomainController"/> over HTTP may use POST requests for queries with side-effects, 
