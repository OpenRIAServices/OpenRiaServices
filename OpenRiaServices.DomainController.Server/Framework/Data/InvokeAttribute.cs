...
{
    /// <summary>
    /// Attribute applied to a <see cref="DomainController"/> method to indicate that it is an invoke operation.
    /// </summary>
    [AttributeUsage(
    ...
    public sealed class InvokeAttribute : Attribute
    {
        ...
        /// </summary>
        /// <remarks>
        /// Operations with side-effects may be invoked differently by consumers of a <see cref="DomainController"/>. For example, 
        /// clients that invoke a <see cref="DomainController"/> over HTTP may use POST requests for invoke operations with side-effects, 
