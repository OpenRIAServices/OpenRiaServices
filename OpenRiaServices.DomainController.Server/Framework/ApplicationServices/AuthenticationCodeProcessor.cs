...
namespace OpenRiaServices.DomainController.Server.ApplicationServices
{
    ...
    internal sealed class AuthenticationCodeProcessor : CodeProcessor
    {
        ...
        private const string AuthenticationDomainContextBaseName =
            "OpenRiaServices.DomainController.Client.ApplicationServices.AuthenticationDomainContextBase";
        ...
        /// </summary>
        /// <param name="DomainControllerDescription">The DomainControllerDescription</param>
        /// <param name="codeCompileUnit">The codeCompileUnit</param>
        /// <param name="typeMapping">The typeMapping</param>
        public override void ProcessGeneratedCode(DomainControllerDescription DomainControllerDescription, CodeCompileUnit codeCompileUnit, IDictionary<Type, CodeTypeDeclaration> typeMapping)
        {
            // Make sure the provider extends IAuthentication<T>
            Type genericDomainControllerType;
            AuthenticationCodeProcessor.CheckIAuthentication(DomainControllerDescription, out genericDomainControllerType);

            Type userEntityType = genericDomainControllerType.GetGenericArguments()[0];
            ...
            typeMapping.TryGetValue(DomainControllerDescription.DomainControllerType, out providerTypeDeclaration);
        ...
        /// </exception>
        private static void CheckIAuthentication(DomainControllerDescription authenticationServiceDescription, out Type genericIAuthenticationType)
        {
            ...
            if (!typeof(IAuthentication<>).DefinitionIsAssignableFrom(authenticationServiceDescription.DomainControllerType, out genericIAuthenticationType))
            {
            ...
            if (!implementsLogin || !implementsLogout || !implementsGetUser || !implementsUpdateUser)
            {
                throw new InvalidOperationException(string.Format(
                    ...
                    authenticationServiceDescription.DomainControllerType.Name));
            }
        }
