using OpenRiaServices.DomainController.Server;

namespace OpenRiaServices.DomainController.Server.ApplicationServices
{
    /// <summary>
    /// An interface for a <see cref="DomainController"/> that encapsulates the authentication domain. A
    /// domain service implementing this interface will be used to populate the user on the client.
    /// </summary>
    /// <remarks>
    /// <c>OpenRiaServices.DomainController.Client.ApplicationServices.WebAuthenticationService</c>
