...
{
    /// <summary>
    /// <see cref="DomainController"/> that encapsulates the authentication domain.
    /// </summary>
    /// <remarks>
    ...
    public abstract class AuthenticationBase<T> : DomainController, IAuthentication<T> where T : IUser, new()
    {
