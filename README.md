...
## Client-side association index usage

OpenRiaServices now keeps internal in-memory indexes for `EntitySet` identity and metadata-backed association lookups.
